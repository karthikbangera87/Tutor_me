...
if (! isset ( $_SESSION ['username'] )) {
	...
	$result = mysqli_query ( $con, "select * from Schedule where UserID='$username' and Date >= '$today' and Status='Approved'" );
	...
	$result1 = mysqli_query ( $con, "select * from Schedule where UserID='$username' and Status='Pending'" );
	...
	$result2 = mysqli_query ( $con, "select * from Schedule where UserID='$username' and Date < '$today' and Status='Approved'" );
				...
				<table width="100%">
					<tr>
						<td valign="top" width="50%"><div class="grid-header"
							...
							<div id="myGrid2" style="width: 640px; height: 125px;"></div></td>
					</tr>
				</table>
